...
> ⚠️ **No es asesoría financiera.** Lee el
> [aviso importante](#aviso-importante--léelo-antes-de-usarla) antes de usarla: las
> decisiones de inversión son tuyas y la app puede equivocarse.
...
**Criptos Trader no es un asesor financiero y no sustituye a uno.**

Lo que la app enseña —el precio, la sugerencia de comprar, vender o mantener, el plan de
inversión, los objetivos y las proyecciones— es **información y cálculo automático con
fines educativos e informativos**. No es asesoría financiera, ni de inversión, ni
tributaria, ni legal, ni una recomendación personalizada, ni una oferta o invitación a
comprar o vender nada. Quien la publica no está registrado ni autorizado como asesor de
inversiones y no conoce tu situación, tus ingresos, tus deudas ni tus objetivos.

**Las decisiones son tuyas, y solo tuyas.**

Eres libre de invertir, de no invertir y de hacer exactamente lo contrario de lo que diga
la app. Antes de poner dinero en algo, consulta a un profesional autorizado y decide por tu
cuenta. Si decides seguir una sugerencia, esa decisión es tuya y asumes por completo el
riesgo y el resultado.

**Las sugerencias se equivocan.**

Salen de reglas fijas aplicadas a datos de precio: no adivinan el futuro y no tienen forma
de saber lo que va a pasar. Lo que ocurrió otras veces **no garantiza** que vuelva a
ocurrir. Las criptomonedas son extremadamente volátiles y **puedes perder parte o la
totalidad del dinero que inviertas**.
...
**Sin garantías y sin responsabilidad.**

El programa se entrega **tal cual («as is»)**, sin garantía de ningún tipo, expresa o
implícita, incluidas —sin limitarse a— las de comerciabilidad, idoneidad para un propósito
concreto, exactitud, disponibilidad o ausencia de errores. En la máxima medida que permita
la ley aplicable, el autor **no será responsable** de ninguna pérdida o daño de ningún tipo
—incluidos pérdidas económicas, pérdida de ganancias, pérdida de oportunidad o daños
directos, indirectos, incidentales, especiales o consecuentes— derivado del uso de esta
aplicación, de la información que muestra, de sus errores o de su falta de disponibilidad,
aunque se hubiera advertido de esa posibilidad.

**Al descargar, instalar o usar Criptos Trader aceptas este aviso.** Si no estás de acuerdo
con alguna parte, no la uses.
